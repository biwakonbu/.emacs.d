...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (eglot dap-mode bui tree-mode company-lsp lsp-ui lsp-mode dash-functional vue-mode edit-indirect ssass-mode vue-html-mode auto-yasnippet ivy-yasnippet git-complete company-flx fuzzy company-statistics rg ag pyenv-mode pythonic quelpa-use-package markdown-mode helm-css-scss scss-mode slim-mode slime-company slime macrostep elpy yasnippet pyvenv highlight-indentation find-file-in-project ivy jedi jedi-core python-environment epc ctable concurrent deferred flymake-cursor helm-migemo migemo json-mode json-snatcher json-reformat yaml-mode web-mode haskell-mode magit magit-popup git-commit with-editor persp-mode dockerfile-mode gist gh logito pcache marshal ht avy anzu smooth-scrolling smooth-scroll yascroll ac-html f mode-icons spaceline powerline ddskk cdb ccc use-package diminish bind-key helm helm-core async init-loader spacemacs-theme smartparens quelpa flymake-python-pyflakes ac-alchemist)))
